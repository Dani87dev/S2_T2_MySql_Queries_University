...
SELECT persona.apellido1, persona.apellido2, persona.nombre FROM profesor JOIN persona ON persona.id = profesor.id_profesor LEFT JOIN asignatura ON asignatura.id_profesor = profesor.id_profesor WHERE asignatura.id_profesor IS NULL;
